...
import * as fflate from 'three/examples/jsm/libs/fflate.module.min.js';
	...
	FBXTreeParser.prototype = {
		...
		createLight: function (relationships) {
			...
			if (lightAttribute === undefined) {
				...
				var intensity = (lightAttribute.Intensity === undefined) ? 1 : lightAttribute.Intensity.value / 200000;
